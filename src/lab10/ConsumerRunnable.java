...
/** Define ConsumerRunnable class and its method(s)
 * 
 * @author edwardlee
 *
 */
public class ConsumerRunnable implements Runnable{
	...
	/** Constructs ConsumerRunnable class object
	 * 
	 ...
	 */
	public ConsumerRunnable(Queue queue, int repeats) {
		if(queue == null)
	...
	public void run() {
		try {
			for(int i = 0; i < repeats; i++) {
				...
				System.out.println("removed from the queue: " + temp);
				Thread.sleep(DELAY);
			}
